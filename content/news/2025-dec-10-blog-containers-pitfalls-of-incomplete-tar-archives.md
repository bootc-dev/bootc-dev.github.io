+++
title = "Blog: Containers: pitfalls of incomplete tar archives"
date = 2025-12-10
slug = "2025-dec-10-blog-containers-pitfalls-of-incomplete-tar-archives"
+++

# Blog: Containers: pitfalls of incomplete tar archives
...
two parts.  First, how to [determine
changes](https://github.com/opencontainers/image-spec/blob/main/layer.md#determining-changes)?:
...
And then the following section on [representing
changes](https://github.com/opencontainers/image-spec/blob/main/layer.md#representing-changes)
...
- When encountering a directory with the xattr, searches through the
  ...
  set.  The metadata for this layer is used.
...
creating OCI images should include their parent information however to
maximize compatibility. We are looking forward to a future where
